...
<head>
  ...
  <title>My Story - This is My story</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Halo I'm Kelly</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="our-story.php">My Story</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="assets/img/gambar1.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <ul>
              <li><i class="bi bi-check-circled"></i> I’m a high-potential and high-achiever. I’m a fast learner and a motivated worker. I enjoy working autonomously and always produce the best possible work. I take on challenges head-on, challenge them first and then implement the solution. I am always able to make quick decisions in emergency situations.</li>
            </ul>
            <p>
